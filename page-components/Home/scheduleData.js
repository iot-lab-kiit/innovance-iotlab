export const scheduleData = [
    {
        schedule: [
            {
                timing: 'November 18, 6:00pm - 6:15pm',
                title: 'Inauguration Ceremony',
                // type: 'Base Event',
                venue: 'Campus 7 Auditorium',
            },
            {
                timing: 'November 18, 6:15pm - 8:30pm',
                title: 'Algo Anecdotes',
                // type: 'Base Event',
                description: 'Hear from our guest speaker - Raj VikramAditya(Striver) about their incredible journey and harness their decade long wisdom and experience in just hours.',
                venue: 'Campus 7 Auditorium',
            },
        ]
    },
    {
        schedule: [
            {
                timing: 'November 19, 10:00am -4:00pm',
                title: 'FuturaForge',
                // type: 'Main Event',
            ...
            {
                timing: 'November 19, 10:00am - 10:20am',
                title: ' IdeaInscribe',
                // type: 'Main Event',
            ...
            {
                timing: 'November 19, 10:20am - 10:35am',
                title: 'ScopeSprint',
                // type: 'Main Event',
            ...
            {
                timing: 'November 19, 10:35am - 11:05am',
                title: 'CollabConnect',
                // type: 'Main Event',
            ...
            {
                timing: 'November 19, 11:05am - 11:30am',
            ...
            {
                timing: 'November 19, 11:30am - 1:10pm',
                title: ' InnoBuild ',
                // type: 'Main Event',
            ...
            {
                timing: 'November 19, 1:10pm - 1:45pm & 2:30pm - 2:55pm',
                title: 'DomainBlend',
                // type: 'Main Event',
            ...
            {
                timing: 'November 19, 2:55pm - 3:05pm',
                title: 'CodeConserve ',
                // type: 'Main Event',
            ...
            {
                timing: 'November 19, 3:05pm - 3:35pm',
                title: ' BrandBlitz',
                // type: 'Main Event',
            ...
            // },
            {
                timing: 'November 19, 3:35pm - 4:00pm',
